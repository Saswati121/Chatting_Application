...
//import static chatting.apllication.Server.dout;
//import static chatting.apllication.Server.f;
//import static chatting.apllication.Server.formatLabel;
//import static chatting.apllication.Server.vertical;
...
public class Client  implements ActionListener {
    ...
    Client(){//Create constructor(Frame all part )
        f.setLayout(null);
        ...
        //for profile image
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/aa.jpeg"));//first create a object for imageicon and carry those image
       ...
       JLabel status=new JLabel("Active Now");
        ...
        f.setLocation(800,50);//its can change the frame open location 
    ...
    public static void main(String[] args){
       Client c = new Client();//create new object for class
       try {
